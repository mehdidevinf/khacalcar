			...
			<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
				...
				<div class="collapse navbar-collapse navbar-ex1-collapse">
					<ul class="nav navbar-nav side-nav">
						...
						<li>
							<a href="{{ url('Client') }}" ><i class="fa fa-fw fa-cog"></i> Compte</a>
						</li>
						<li>
							<a href="{{ url('SettingClient') }}"><i class="fa fa-fw fa-bars"></i> Paramètres</a>
						</li>
						<li>
							<a href="{{ url('PasswordClient') }}" ><i class="fa fa-fw fa-unlock-alt"></i> Mot de passe</a>
						</li>
						<li>
							<a href="{{ url('ListDemande') }}" ><i class="fa fa-fw fa-user-plus"></i> Demande</a>
						</li>
						<li>
							<a href="{{ url('ListVoiture') }}" ><i class="fa fa-fw fa-car"></i> Voiture</a>
						</li>					
					</ul>
				</div>
			</nav>
